# Chapitre 5 — La signature du mandat et le suivi

> **Un vendeur intéressé n'est pas un mandat signé.** Entre « ça m'intéresse » et la signature, il y a le rendez-vous, l'estimation, la confiance — et souvent plusieurs relances. La majorité des mandats se signent dans le **suivi**, pas au premier appel.

---

## 5.1 Le rendez-vous / l'estimation : objectif intermédiaire clé

L'appel sert à décrocher un **rendez-vous** (physique ou estimation). C'est là que la confiance se construit et que le mandat se signe. Prépare-le.

### Avant le RDV
- Relire l'annonce et tes notes (modèle, prix, situation du vendeur).
- Préparer une **estimation de fourchette de prix** (cote + annonces comparables).
- Préparer les **documents** : présentation de l'agence, exemple de mandat, grille de services (garantie, financement).
- Confirmer le RDV par SMS la veille ou le matin (réduit les lapins).

### Pendant le RDV
1. **Mettre en confiance** : on discute, on écoute, on inspecte la voiture **avec** le vendeur.
...
> 🎯 Le vendeur doit repartir avec une **certitude** : « ces gens sont sérieux, locaux, transparents, et ils vont me simplifier la vie ».

---

## 5.2 Conclure : faire signer le mandat
...
## 5.3 La relance : là où se gagne la majorité du business

La plupart des vendeurs ne disent pas « oui » au premier contact. **Le suivi est ton plus gros gisement de mandats.** La statistique classique de la vente : une grande partie des affaires se conclut après **plusieurs** relances, alors que la plupart des commerciaux **abandonnent dès le 1er ou 2e contact**. Sois celui qui relance proprement.

### Cadence de relance suggérée (à adapter)

| Situation du contact | Action de relance |
|---|---|
| Pas répondu (1er appel) | Rappeler à un **autre créneau** (j+1 / j+2). Varier les horaires. |
| Tiède, « j'y réfléchis » | Rappel sous **3 à 5 jours**, avec un **nouvel angle** ou une info utile. |
| « Pas pressé / pas maintenant » | Relance **mensuelle** légère (« votre voiture est-elle vendue ? »). |
| A dit non mou | Relance à **2-3 semaines** : souvent il galère toujours. |
| Non ferme / ne plus rappeler | **Stop.** On respecte. |

> 💡 **L'astuce qui marche :** beaucoup de vendeurs qui ont dit « non, je gère seul » **galèrent toujours 3 semaines plus tard**. Une relance bien placée — _« Bonjour M. Dupont, je vois que votre 308 est toujours en ligne, ça avance comme vous voulez ? »_ — tombe pile au moment où ils sont mûrs. **C'est de l'or.**

### Règles de relance saine (≠ harcèlement)

- Toujours **apporter quelque chose** (une question, une info, un nouvel angle), jamais juste « alors, vous avez réfléchi ? ».
...
## 5.4 Après la signature : ton image continue
...
## 5.5 Le cycle complet en un coup d'œil

```
   PIGE Leboncoin
        │
        ▼
   QUALIFICATION (fiche de suivi)
        │
        ▼
   ...
   SIGNATURE DU MANDAT  ✅
        │
        ▼
   SUIVI + INFO VENDEUR + RECOMMANDATIONS
```

---

**➡️ Chapitre suivant : [Bonnes pratiques, déontologie & checklists](06-bonnes-pratiques-checklist.md)**
