# 📕 La Bible de la Prospection — BH CAR Roanne

> **Dépôt-vente de véhicules d'occasion — Acquisition de mandats**
> Document de référence pour les alternants en charge de la recherche et de l'acquisition de mandats.
> _Rentrée 2026 — Agence de Roanne._

---

## À qui s'adresse ce dossier ?

À toi, nouvel alternant chez BH CAR Roanne. Ton métier : **trouver des voitures à vendre** pour le compte de particuliers, et convaincre ces particuliers de nous confier la vente de leur véhicule (le « mandat »). En échange, nous gérons tout (annonce, visites, négociation, paperasse, services) et nous prenons une commission une fois la vente réalisée.

C'est exactement le même principe que **l'agent immobilier** : sans mandat, pas de stock ; sans stock, pas de chiffre. **Ton rôle est le point de départ de toute la chaîne de valeur de l'entreprise.**

---

## Comment utiliser cette bible

Lis-la une première fois en entier, puis garde-la comme référence. Chaque chapitre est conçu pour être consulté seul, au moment où tu en as besoin.
...
- **Sur l'offre ou un prix** → ton tuteur / le responsable d'agence.
- **Sur un cas client compliqué** → on en parle en équipe, on ne s'engage jamais seul sur ce qu'on ne maîtrise pas.
- **Sur la légalité / le RGPD** → chapitre 6, puis ton responsable.

> _Bonne prospection. Le téléphone ne va pas décrocher tout seul. 📞_
